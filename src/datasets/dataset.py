...
from typing import Union, Optional, Sequence, NamedTuple, Literal
...
DATASET_METADATA = {
    ...
    "compressible_flow/CE-Gauss": Metadata(
        ...
        signed=SIGNED_CE,
        names=NAMES_CE,
        global_mean=[0.80, 0.0, 0.0, 2.513],
    ...
    "compressible_flow/CE-RP": Metadata(
        ...
        signed=SIGNED_CE,
        names=NAMES_CE,
        global_mean=[0.80, 0.0, 0.0, 0.215],
        global_std=[0.31, 0.391, 0.356, 0.185],
    ),
    "compressible_flow/CE-CRP": Metadata(
        ...
        signed=SIGNED_CE,
        names=NAMES_CE,
        global_mean=[0.80, 0.0, 0.0, 0.553],
        global_std=[0.31, 0.391, 0.356, 0.185],
    ),
    ...
    "eagle/triangle": Metadata(
        ...
        type="gaot",
        fix_x=False,
        domain_x=([-3.0, -2.0], [3.0, 2.0]),
        domain_t=(0.0, 1.0),
        active_variables=[0, 1, 2],
        chunked_variables=[0, 0, 1],
        num_variable_chunks=2,
        signed={"u": [True, True, True], "c": None},
        names={"u": ["$v_x$", "$v_y$", "$p$"], "c": None},
        global_mean=[0.0, 0.0, 0.0],
        global_std=[1.0, 1.0, 1.0],
        group_mask="mask",
    ),
    "eagle/triangle_full": Metadata(
        periodic=False,
        group_u="u",
        group_c=None,
        group_x="x",
        ...
        chunked_variables=[0, 0, 1, 1],
        num_variable_chunks=2,
        signed={"u": [True, True, True, True], "c": None},
        names={"u": ["$v_x$", "$v_y$", "$p_s$", "$p_g$"], "c": None},
